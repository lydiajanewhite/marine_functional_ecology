...
```{r}
gs4_deauth()
#productivity <- read_sheet("1fXSKn11OsET_SrR7sIbFTcflnglbaVWv44oULKhfo4s", sheet = "fucus_productivity_summary") 

productivity <- read_sheet("1STH7IQobfCN5dumGnuSGqDiIoqHk1IkAUg3TTRu0pVc", sheet = "fucus_productivity_summary") 
