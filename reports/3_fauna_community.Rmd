...
#abundance <- read_sheet("1fXSKn11OsET_SrR7sIbFTcflnglbaVWv44oULKhfo4s" , sheet = "benthos_abundance_per sample") #2025

abundance <- read_sheet("1STH7IQobfCN5dumGnuSGqDiIoqHk1IkAUg3TTRu0pVc" , sheet = "benthos_abundance_per sample") #2024
...
In order to do multivariate stastitics on biomass data, individual species must be weighed which is not feasible here, due to low abudances in our samples. 
