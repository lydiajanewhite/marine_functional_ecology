...
#stocks <- read_sheet("1fXSKn11OsET_SrR7sIbFTcflnglbaVWv44oULKhfo4s", sheet = "carbon_stocks_m2") #2025

stocks <- read_sheet("1STH7IQobfCN5dumGnuSGqDiIoqHk1IkAUg3TTRu0pVc", sheet = "carbon_stocks_m2") #2024
...
ggplot(stocks_long, aes(x = site, y = carbon_stock, fill = site)) +
  geom_boxplot() +
  facet_wrap(~ factor(compartment, levels = compartment_order)) +
